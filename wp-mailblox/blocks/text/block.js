(function (wp) {
    ...
    registerBlockType('email-builder/text', {
        title: 'Text',
        ...
        edit: function (props) {
            ...
            var _desktopFontSize = _preset.body_size || 16;
            var _mobileFontSize  = _preset.body_size_mobile || _desktopFontSize;
            ...
            return wp.element.createElement(
                'div', {
                    className: 'eb-text-block',
                    style: { opacity: (isMobilePreview && attributes.hideOnMobile) ? 0.3 : undefined },
                    ref: containerRef,
                },
