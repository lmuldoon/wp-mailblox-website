(function (wp) {
    ...
    registerBlockType('email-builder/header', {
        title: 'Header',
        ...
        edit: function (props) {
            ...
            const autoColor = useSelect(function(select) {
                ...
                // Walk parents to find section/columns background — re-runs when any block attribute changes
            ...
            var _desktopFontSize = _preset.heading_size || 28;
            var _mobileFontSize  = _preset.heading_size_mobile || _desktopFontSize;
            ...
            return wp.element.createElement(
                'div',
                { className: 'eb-header-block', style: { opacity: (isMobilePreview && attributes.hideOnMobile) ? 0.3 : undefined }, ref: containerRef },
                ...
                wp.element.createElement(RichText, {
                    ...
                    className: disableDarkTextColour ? 'eb-dark-text-colour-disabled' : 'eb-dark-text-colour-enabled' ,
                    style:       {
