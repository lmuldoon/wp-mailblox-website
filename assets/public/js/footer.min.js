...
function createHeroBlocks() {
  ...
  function drawIsoCube(cx, cy, s, rgb, alpha) {
    ...
    ctx.closePath();
    ctx.fillStyle = "rgba(".concat(r, ",").concat(g, ",").concat(b, ",").concat(alpha, ")");
    ctx.fill();
    ...
    ctx.lineTo(ctr[0], ctr[1]);
    ctx.closePath();
    ctx.fillStyle = "rgba(".concat(r, ",").concat(g, ",").concat(b, ",").concat(alpha * 0.6, ")");
    ctx.fill();
    ...
    ctx.closePath();
    ctx.fillStyle = "rgba(".concat(r, ",").concat(g, ",").concat(b, ",").concat(alpha * 0.35, ")");
    ctx.fill();

    // Top-edge highlight
    ctx.strokeStyle = "rgba(".concat(r, ",").concat(g, ",").concat(b, ",").concat(alpha * 0.55, ")");
    ctx.lineWidth = 0.6;
    ctx.beginPath();
    ctx.moveTo(top[0], top[1]);
    ctx.lineTo(tr[0], tr[1]);
  ...
  function makeBlock(preplaced) {
    ...
    var s = 55 + Math.random() * 65; // 55–120 px half-size
    return {
      x: Math.random() * W,
...
/* harmony import */ var _scripts_nav_toggle__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./scripts/nav-toggle */ "./assets/src/js/scripts/nav-toggle.js");
/* harmony import */ var _scripts_animations__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./scripts/animations */ "./assets/src/js/scripts/animations.js");
/* harmony import */ var _scripts_email_client__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./scripts/email-client */ "./assets/src/js/scripts/email-client.js");
/* harmony import */ var _scripts_lazyload_frame__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./scripts/lazyload-frame */ "./assets/src/js/scripts/lazyload-frame.js");
/* harmony import */ var _scripts_lazyload_frame__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_scripts_lazyload_frame__WEBPACK_IMPORTED_MODULE_8__);
...
_scripts_nav_toggle__WEBPACK_IMPORTED_MODULE_5__.MenuController.init();

(0,_scripts_animations__WEBPACK_IMPORTED_MODULE_6__.initAnimations)();

(0,_scripts_email_client__WEBPACK_IMPORTED_MODULE_7__.initEmailClient)();
...
var galleryLightbox = glightbox__WEBPACK_IMPORTED_MODULE_9___default()({
...
var locationLightbox = glightbox__WEBPACK_IMPORTED_MODULE_9___default()({
  selector: '.gl-single-image',
  loop: false,
  zoomable: true
});
var inlineLightbox = glightbox__WEBPACK_IMPORTED_MODULE_9___default()({
