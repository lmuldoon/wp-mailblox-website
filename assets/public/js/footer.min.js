...
function animateElements() {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray(".parallax-up").forEach(function (item) {
    var content = $(item).find('.parallax-up--element');
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray(".animated").forEach(function (elem, index) {
    ...
    imgs.each(function () {
      var $img = $(this);
      var isCarouselImage = $img.closest('.js-card-carousel').length > 0;
      var isHeroImage = $img.closest('.parallax-up').length > 0;
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray(".animated-up").forEach(function (elem) {
    ...
    gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.create({
      ...
      // prevent initial transform before ScrollTrigger decides
      onEnter: function onEnter() {
  ...
  var headerInner = $header.find('.site-header__inner');

  // Set initial state: move up and hidden
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(headerInner, {
    y: -50,
    // move 50px above
    opacity: 0
  });
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(headerInner, {
    y: 0,
    opacity: 1,
    duration: 1,
    ease: "power2.out"
...
/* harmony import */ var _scripts_lazyload_frame__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./scripts/lazyload-frame */ "./assets/src/js/scripts/lazyload-frame.js");
/* harmony import */ var _scripts_lazyload_frame__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_scripts_lazyload_frame__WEBPACK_IMPORTED_MODULE_7__);
...
var galleryLightbox = glightbox__WEBPACK_IMPORTED_MODULE_8___default()({
...
var locationLightbox = glightbox__WEBPACK_IMPORTED_MODULE_8___default()({
  selector: '.gl-single-image',
  loop: false,
  zoomable: true
});
var inlineLightbox = glightbox__WEBPACK_IMPORTED_MODULE_8___default()({
