...
/***/ "./assets/src/js/scripts/accordian-controller.js":
/*!*******************************************************!*\
  !*** ./assets/src/js/scripts/accordian-controller.js ***!
  \*******************************************************/
/***/ (function() {
...
(function ($) {
  ...
  var BUTTON_HTML = '<button class="accordion-button" type="button" aria-label="Toggle accordion"><svg xmlns="http://www.w3.org/2000/svg" width="40.898" height="40.898" viewBox="0 0 40.898 40.898"><g transform="translate(-1314.5 -2098.5)"><path d="M1,40.9H-1V0H1Z" transform="translate(1334.949 2098.5)" fill="#96ae23"/><path d="M1,40.9H-1V0H1Z" transform="translate(1355.398 2118.949) rotate(90)" fill="#96ae23"/></g></svg></button>';
  var $wrappers = $('.accordions-wrapper');
  if (!$wrappers.length) {
    return;
  }
...
function createHeroBlocks() {
  ...
  function drawIsoCube(cx, cy, s, rgb, alpha) {
    ...
    var top = [cx, cy - s];
    var tr = [cx + s * c, cy - s * 0.5];
    var br = [cx + s * c, cy + s * 0.5];
    var bot = [cx, cy + s];
    var bl = [cx - s * c, cy + s * 0.5];
    var tl = [cx - s * c, cy - s * 0.5];
    var ctr = [cx, cy];
  ...
  function makeBlock(preplaced) {
    var rgb = PALETTES[Math.floor(Math.random() * PALETTES.length)];
    var s = 30 + Math.random() * 30; // 30–60 px half-size
    return {
      x: spawnX(),
  ...
  function tick() {
    ...
    var vg = ctx.createRadialGradient(W * 0.5, H * 0.5, H * 0.15, W * 0.5, H * 0.5, H * 0.85);
  ...
  blocks = Array.from({
    ...
    return makeBlock(true);
  });
  tick();
  window.addEventListener('resize', (0,_event_utilities__WEBPACK_IMPORTED_MODULE_0__.debounce)(function () {
    resize();
    var c = targetCount();
...
function animateHero() {
  ...
  var heroImg = document.querySelector('.hero-img img, .hero-img .img-placeholder');
  ...
  if (h1) {
    ...
    var wrappedLines = lines.map(function (line) {
      return line.replace(/(\S+)/g, function (word) {
        return "<span class=\"hero-word\"><span class=\"hero-word__inner\">".concat(word, "</span></span>");
      });
    });
  ...
  // ── Hero image ────────────────────────────────────────────────────────────
  if (heroImg) {
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.fromTo(heroImg, {
      opacity: 0,
      y: 36,
      scale: 0.97
    }, {
...
function animateElements() {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray(".parallax-up").forEach(function (item) {
    var overlay = $(item).find('.hero--overlay');
  ...
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray(".animated").forEach(function (elem) {
    ...
    imgs.each(function () {
      var $img = $(this);
      var isCarousel = $img.closest('.js-card-carousel').length > 0;
      var isHero = $img.closest('.parallax-up').length > 0;
...
function animatePricingCards() {
  ...
  var _pricingSection$query = pricingSection.querySelectorAll('.pricing-card'),
    _pricingSection$query2 = _slicedToArray(_pricingSection$query, 2),
    freeCard = _pricingSection$query2[0],
    proCard = _pricingSection$query2[1];
  if (!freeCard || !proCard) return;
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(freeCard, {
    opacity: 0,
    x: -30
  });
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(proCard, {
    opacity: 0,
    x: 30
  });
  gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.create({
...
function initMagneticButtons() {
  var buttons = document.querySelectorAll('.button--primary, .button--nav');
...
/***/ "./assets/src/js/scripts/checkout.js":
/*!*******************************************!*\
  !*** ./assets/src/js/scripts/checkout.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initCheckout: function() { return /* binding */ initCheckout; }
/* harmony export */ });
function initCheckout() {
  window.addEventListener('load', function () {
    if (!window.FS || !FS.Checkout) return;
    var checkout = new FS.Checkout({
      product_id: 27104,
      plan_id: 44844
    });
    document.querySelectorAll('.js-get-pro').forEach(function (btn) {
      btn.addEventListener('click', function (e) {
        e.preventDefault();
        checkout.open({
          name: 'WP Mailblox Pro'
        });
      });
    });
  });
...
/***/ "./assets/src/js/scripts/email-client.js":
/*!***********************************************!*\
  !*** ./assets/src/js/scripts/email-client.js ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initEmailClient: function() { return /* binding */ initEmailClient; }
/* harmony export */ });
...
function initEmailClient() {
  var client = document.querySelector('.email-client');
  if (!client) return;
  var items = Array.from(client.querySelectorAll('.inbox-item'));
  var previewPane = client.querySelector('.email-client__preview');
  var previewImg = client.querySelector('.email-preview__img');
  if (!previewPane || !previewImg) return;
  var images = ['/static/images/email-examples/bright-n-light.jpg', '/static/images/email-examples/appy.jpg', '/static/images/email-examples/automotive.jpg', '/static/images/email-examples/b-fashion.jpg', '/static/images/email-examples/chic.jpg', '/static/images/email-examples/church.jpg', '/static/images/email-examples/honey.jpg', '/static/images/email-examples/itsuki.jpg', '/static/images/email-examples/ladies-fitness.jpg', '/static/images/email-examples/real-estate.jpg', '/static/images/email-examples/salt.jpg'];
  var DURATION = 7000; // ms per email
  var current = 0;
  var timer = null;
  ...
  function switchTo(index) {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(previewImg, {
      opacity: 0,
      duration: 0.25,
      ease: 'power2.in',
  ...
  function startProgress() {
    ...
    items.forEach(function (item) {
      var bar = item.querySelector('.inbox-item__progress');
      if (bar) gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(bar, {
        scaleX: 0
      });
    });
    var activeBar = items[current].querySelector('.inbox-item__progress');
    if (!activeBar) return;
    progressTween = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(activeBar, {
      scaleX: 0
    }, {
      scaleX: 1,
...
/***/ "./assets/src/js/scripts/init.tabs.js":
/*!********************************************!*\
  !*** ./assets/src/js/scripts/init.tabs.js ***!
  \********************************************/
/***/ (function() {
...
(function ($) {
  $('.js-tabs').each(function (index, tabsContainer) {
    var tablist = tabsContainer.querySelector('.tab-buttons');
    var tabs = tabsContainer.querySelectorAll('.tab-button');
    var panels = tabsContainer.querySelectorAll('.tab-panel');
    var container = tabsContainer; // container for height adjustment
    ...
    function switchTab(newTab) {
      ...
      var newIndex = Array.prototype.indexOf.call(tabs, newTab);
    ...
    $(window).on('resize', function () {
      var activeIndex = Array.prototype.findIndex.call(tabs, function (t) {
        return t.hasAttribute('aria-selected');
      });
...
/***/ "./assets/src/js/scripts/lazyload-frame.js":
/*!*************************************************!*\
  !*** ./assets/src/js/scripts/lazyload-frame.js ***!
  \*************************************************/
/***/ (function() {
...
function lazyLoadFrame($target) {
  var $frame = jQuery($target.data('lazy-frame'));
...
(function ($) {
  var $lazyFrames = jQuery('[data-lazy-frame]');
  if ($lazyFrames.length) {
    $lazyFrames.click(function (event) {
      var $target = jQuery(event.target).closest('[data-lazy-frame]');
...
var targetElement = document.querySelector('#js-site-header');
var isOpen = false;
...
function openMenu() {
  ...
  (0,body_scroll_lock__WEBPACK_IMPORTED_MODULE_1__.disableBodyScroll)(targetElement, {
...
function closeMenu() {
  ...
  (0,body_scroll_lock__WEBPACK_IMPORTED_MODULE_1__.enableBodyScroll)(targetElement);
  var tl = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
    onComplete: function onComplete() {
      isAnimating = false;
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set($nav[0], {
...
/* harmony import */ var _iconify_iconify__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @iconify/iconify */ "./node_modules/@iconify/iconify/dist/iconify.mjs");
/* harmony import */ var _scripts_header_collapse__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scripts/header-collapse */ "./assets/src/js/scripts/header-collapse.js");
/* harmony import */ var _scripts_checkout__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./scripts/checkout */ "./assets/src/js/scripts/checkout.js");
/* harmony import */ var _scripts_nav_toggle__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./scripts/nav-toggle */ "./assets/src/js/scripts/nav-toggle.js");
/* harmony import */ var _scripts_animations__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./scripts/animations */ "./assets/src/js/scripts/animations.js");
/* harmony import */ var _scripts_email_client__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./scripts/email-client */ "./assets/src/js/scripts/email-client.js");
/* harmony import */ var _scripts_lazyload_frame__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./scripts/lazyload-frame */ "./assets/src/js/scripts/lazyload-frame.js");
/* harmony import */ var _scripts_lazyload_frame__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_scripts_lazyload_frame__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var glightbox__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! glightbox */ "./node_modules/glightbox/dist/js/glightbox.min.js");
/* harmony import */ var glightbox__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(glightbox__WEBPACK_IMPORTED_MODULE_10__);
...
_scripts_header_collapse__WEBPACK_IMPORTED_MODULE_4__.HeaderStateController.init();

(0,_scripts_checkout__WEBPACK_IMPORTED_MODULE_5__.initCheckout)();

_scripts_nav_toggle__WEBPACK_IMPORTED_MODULE_6__.MenuController.init();

(0,_scripts_animations__WEBPACK_IMPORTED_MODULE_7__.initAnimations)();

(0,_scripts_email_client__WEBPACK_IMPORTED_MODULE_8__.initEmailClient)();
__webpack_require__(/*! ./scripts/init.tabs */ "./assets/src/js/scripts/init.tabs.js");
__webpack_require__(/*! ./scripts/accordian-controller */ "./assets/src/js/scripts/accordian-controller.js");
...
var galleryLightbox = glightbox__WEBPACK_IMPORTED_MODULE_10___default()({
...
var locationLightbox = glightbox__WEBPACK_IMPORTED_MODULE_10___default()({
  selector: '.gl-single-image',
  loop: false,
  zoomable: true
});
var inlineLightbox = glightbox__WEBPACK_IMPORTED_MODULE_10___default()({
  selector: '.glightbox-inline',
  loop: false,
  // prevents looping to the next/previous modal
  closeButton: true,
  // show close button
  touchNavigation: false,
  dragable: false,
  ...
  closeEffect: 'fade',
  slideEffect: 'fade',
  // ensures no sliding effect that implies carousel
  moreText: false,
  // optional, disables any "more" links
  width: '1000px',
...
$(window).on('resize', (0,_scripts_event_utilities__WEBPACK_IMPORTED_MODULE_0__.debounce)(function (event) {
  storeHeaderAndFooterHeight();
}, 150));
$(window).on('scroll', (0,_scripts_event_utilities__WEBPACK_IMPORTED_MODULE_0__.debounce)(function (event) {
  storeHeaderAndFooterHeight();
}, 100));
...
(function ($) {
  ...
  var $nav = $('.site-menu li a');
  function updateActiveNav() {
    var headerHeight = $header.outerHeight();
    var scrollPosition = $(window).scrollTop() + headerHeight + 5;
